...
public class ReactorAgentRule implements AgentRule {
    ...
    public static class Mono {
        ...
        public static void enter() {
            if (AgentRuleUtil.isEnabled()) { MonoAgentIntercept.enter(); }
        }
    }
    ...
    public static class Flux {
        @Advice.OnMethodEnter
        public static void enter() {
            if (AgentRuleUtil.isEnabled()) { FluxAgentIntercept.enter(); }
        }
    }
    ...
    public static class ParallelFlux {
        @Advice.OnMethodEnter
        public static void enter() {
            if (AgentRuleUtil.isEnabled()) { ParallelFluxAgentIntercept.enter(); }
        }
    }
